...
this is a wrapper around summarySEwithin (above); it adds the confidence intervals and groupmean into the original dataframe, rather than into a new dataframe, which makes it possible to include these in a violin plot
