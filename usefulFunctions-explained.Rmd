...
## Load the functions automatically from Github

This function loads all the functions stored in the */tools* folder. It requires two arguments, urlFolder that is the url of the github at the master tree level, and the urlRaw, that is the raw address of the folder.
